...
class BoxCoxScaler(BaseEstimator, TransformerMixin):
    ...
    BoxCoxScaler method to Gaussianize heavy-tailed data
        ...
        -  the Box-Cox transformation is to be used to
        - - stabilize variance
...
#        self.verbose = verbose
    ...
    def transform(self, X):
        """
        Transform data using a previously learned BoxCox coefficents for data.
...
class LambertScaler(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X):
        """
        Fit a Lambert transformation to each column in 2d array. 
        Shape assumed for array is (n-row,n-column)
    ...
    def inverse_transform(self, y):
        """
        Recover original data from Lambert transformation.
        """
