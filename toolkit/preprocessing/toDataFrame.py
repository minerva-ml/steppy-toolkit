...
class toDataFrame(BaseTransformer):
    """
    A Step to transform a numpy 1-D or 2-D array 
    ...
    def transform(self, X, labels=[]):
        """
        Transform a numpy 1-D or 2-D array into a pandas Series or DataFrame.
        
        Args:
            X: (dataFrame,numpy array,list)
            labels: (single label str or list label str):  The column labels name to  be used for new DataFrame. If number of column names given is less than number of column names needed, then they will generared as Column_0...Column_n, where n is the number of missing column names.
        ...
        Raises:
            ...
            2. ValueError will result if labels is not str or list of strings. 
